  ...
  return (
    <header className="border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 sticky top-0 z-50">
      <div className="container mx-auto px-4 py-4">
        ...
        {/* Mobile Navigation */}
        <nav
          className={`md:hidden flex flex-col items-start space-y-2 mt-4 ${
            isMenuOpen ? "block" : "hidden"
          }`}
        >
          <Link
            href="/"
            className={`flex items-center gap-2 px-3 py-2 rounded-md transition-colors font-medium w-full ${
              pathname === "/"
                ? "bg-[#181F2A] text-white"
                : "text-[#181F2A] hover:bg-gray-100"
            }`}
